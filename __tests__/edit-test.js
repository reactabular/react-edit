...
describe('edit.edit', function () {
  it('activates editing', function () {
    ...
    expect(receivedProperty).toEqual(testProperty);
  });
  ...
  it('returns an editor', function () {
    ...
    expect(result.children.type).toEqual(editorElement);
    expect(result.children.props.value).toEqual(value);
  });
  ...
  it('passes onValue to an editor', function () {
    ...
    expect(receivedValue).toEqual(editorValue);
    expect(receivedProperty).toEqual(editorProperty);
  });
  ...
  it('passes extraParameters to an editor', function () {
    ...
    expect(result.children.props.value).toEqual(rowValue);
    expect(result.children.props.extraParameters.rowData.bar).toEqual(rowDataBar);
  });
  ...
  it('allows value and onValue to be replaced', function () {
    ...
    expect(result.children.type).toEqual(editorElement);
    expect(result.children.props[testValue]).toEqual(value);
    expect(result.children.props[testOnValue]).toBeDefined();
  });
  ...
  it('allows activation event to be replaced', function () {
    ...
    expect(result[testEvent]).toBeDefined();
  });
  ...
  it('onActivate gives access to event', function () {
    ...
    expect(receivedEvent.target.className).toEqual(testClassName);
  });
  ...
  it('accepts custom value callback', function () {
    ...
    expect(renderedValue.innerHTML).toEqual(testValue);
  });
